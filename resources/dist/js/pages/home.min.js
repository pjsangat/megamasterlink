...
$(document).ready(function(){$("#home-slider").owlCarousel({items:1,loop:!0,margin:0,autoplay:!0,mouseDrag:!1,touchDrag:!0,autoplayTimeout:3e3,animateOut:"fadeOut",autoplayHoverPause:!1}),$("#services-slider").owlCarousel({center:!0,items:1,margin:0,autoWidth:!0,loop:!0,autoplay:!0}),$("#requestQuotation").validate({rules:{Name:{required:!0},Email:{required:!0,email:!0},Phone:{required:!0},Subject:{required:!0},Message:{required:!0}},submitHandler:function(e){var s;grecaptcha.getResponse()?(console.info(e),s={url:GLOBAL_DOF_BASE_URL+"home/request_quotation",type:"POST",data:$(e).serialize()},console.info(s),ajaxRequest(s,function(e,s){var o="";if(o+="<p>"+s.message+"</p>",0==s.success){if($("#requestQuotation").find(".message").removeClass("error"),$("#requestQuotation").find(".message").removeClass("success"),$("#requestQuotation").find(".message").addClass("error"),0<s.error.length){o+="<ul>";for(var a=0;a<s.error.length;a++)o+="<li>"+s.error[a]+"</li>";o+="</ul>"}}else $("#requestQuotation").find(".message").removeClass("error"),$("#requestQuotation").find(".message").removeClass("success"),$("#requestQuotation").find(".message").addClass("success");$("#requestQuotation").find(".message").html(o)}),console.info(s)):alert("Please confirm captcha to proceed")}}),$("#btnSendRequest").click(function(){$("#requestQuotation").submit()})}),$(window).on("load",function(){});